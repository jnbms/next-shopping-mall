...
export default function Product() {
  ...
  return <Style>
      <motion.div className="product-image" layoutId="product">
        <Image layout="fill" src={shoe} alt="shoe" />
    ...
    <div className="content">
      ...
      <div className="scroller">
        ...
        <Space height={1}/>
        <P1 className="coment">
          이 제품은 가장 흔한 하얀 색상을 베이스로 스포티한 디자인으로 평상시에 캐주얼하게 신을 수 있습니다.
        </P1>
        <Space height={3}/>
        <H2>COLORS</H2>
        <Space height={0.4}/>
        ...
        <div className="row quantity-container">
          ...
          <Input className="input" defaultValue={selectedQuantity}/>
          <motion.div className="button" whileTap={{scale: 0.9}}
